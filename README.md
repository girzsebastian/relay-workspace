...
**Status: desktop alpha 0.6.0.** One Electron codebase targets macOS and Windows. See [validation](docs/VALIDATION.md) for what has actually been tested. This is not yet a hosted service or a production subscription product, and released builds are unsigned.
